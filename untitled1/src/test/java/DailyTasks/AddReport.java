...
public class AddReport {
    ...
    public void setExtent() {
        extent = new ExtentReports(System.getProperty("user.dir") + "/target/Report.html", true);
    ...
    public void tearDown(ITestResult result) throws IOException {
        ...
        if (result.getStatus() == ITestResult.FAILURE) {
            ...
            String screenshotPath = AddReport.getScreenshot(driver, result.getName());
    ...
    public static void main(String[] args) throws EmailException, MalformedURLException {
     ...
     //   email.setAuthentication(new DefaultAuthenticator("palvimonga884@gmail.com", "12qwerty34"));
